...
def paystack_button(context, button_id="django-paystack-button", button_class="", amount=None, ref=None, email=None, redirect_url=None, icon="", words="Pay Now"):
    new_ref = ref
    ...
    if not new_redirect_url:
        ...
        new_redirect_url = "{}?amount={}".format(
        reverse(new_redirect_url, args=[new_ref]), new_amount)
